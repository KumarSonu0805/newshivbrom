                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar nav-compact flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview <?php echo activate_dropdown('bookings'); ?>">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo base_url("bookings/"); ?>" class="nav-link <?php echo activate_menu('bookings'); ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>New Booking</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item has-treeview <?php echo activate_dropdown('projects'); ?>">
                                <a href="#" class="nav-link <?php echo activate_dropdown('projects','a'); ?>">
                                    <i class="nav-icon far fa-list-alt"></i>
                                    <p>Projects <i class="right fas fa-angle-left"></i></p>
                                </a>
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo base_url("projects/addproject/"); ?>" class="nav-link <?php echo activate_menu('projects/addproject'); ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Add Project</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo base_url("projects/"); ?>" class="nav-link <?php echo activate_menu('projects'); ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Projects</p>
                                        </a>
                                    </li>
                            ...
                            ?>
                            <li class="nav-item has-treeview <?= activate_dropdown('members'); ?> d-none">
                                <a href="#" class="nav-link <?= activate_dropdown('members','a'); ?>">
                                    <i class="nav-icon fas fa-users"></i>
                                    <p>Members <i class="right fas fa-angle-left"></i></p>
                                </a>
                            ...
                            <li class="nav-item has-treeview <?php echo activate_dropdown('wallet','li',array('incomes')); ?> d-none">
                            ...
                            <li class="nav-item has-treeview <?php echo activate_dropdown('wallet','li',array('wallettransfer')); ?> d-none">
