...
defined('PROJECT_NAME')        OR define('PROJECT_NAME',"Shivbrom City"); 
defined('OUR_BRAND')       	   OR define('OUR_BRAND',"");
defined('SESSION_YEAR')        OR define('SESSION_YEAR',"$curyear");
defined('SITE_SALT')           OR define('SITE_SALT',"Shivbrom City");
defined('TP')        		   OR define('TP',"sc_"); // Table Prefix
...
defined('NAVBAR_COLOR')        OR define('NAVBAR_COLOR',"navbar-sc-green navbar-dark");
defined('BRAND_COLOR')         OR define('BRAND_COLOR',"navbar-sc-green");
defined('SIDEBAR_COLOR')       OR define('SIDEBAR_COLOR',"sidebar-dark-theme sidebar-dark-sc-green");
//////////////////////////////////////////////
...
if(isset($_SERVER['HTTP_HOST']) && ($_SERVER['HTTP_HOST']=='localhost')){
	...
	defined('DB_PASSWORD')  ? null : define('DB_PASSWORD', 'Shivbrom@123#$');
